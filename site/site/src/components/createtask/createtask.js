...
const CreateTask = () => {
    ...
    const AddCard = async () => {
        const data = await fetch(API_BASE + "/findstudent", {
            method: "POST",
            headers:{
                    ...
                    <form >
                        <ul className='createtask__inputs'>
                            <li className='createtask__inputs--item'>
                                ...
                                <input required placeholder="Введите название" 
                            ...
                            <li className='createtask__payment'>
                                <div className='createtask__payment--item'>
                                    ...
                                    <input required placeholder="Введите бюджет"
                                    className='createtask__input--payment'
                        ...
                        <div className='createtask__about'>
                            ...
                            <textarea placeholder="Введите описание" className='createtask__textarea'
                            onChange={e => setCardDescription(e.target.value)}
                            value={cardDescription}
                            ></textarea>
                        </div>
                        <button type="submit" className="createtask__button" onClick={AddCard}>ОПУБЛИКОВАТЬ ЗАНЯТИЕ</button>
                    </form>
                </div>
            </div>
